...
vim.keymap.set('t', '<M-t>', '<C-\\><C-n>', { desc = 'Exit terminal mode' })
...
vim.keymap.set('n', 'g;', '<C-^>', { desc = 'Switch to the alternate file' })
vim.keymap.set('n', '<M-j>', '<cmd>cnext<CR>')
vim.keymap.set('n', '<M-k>', '<cmd>cprev<CR>')
vim.keymap.set('n', '<leader>d', vim.diagnostic.open_float)
vim.keymap.set({ 'n', 'v' }, 'H', '^', { desc = 'Jump to beginning of the line' })
vim.keymap.set({ 'n', 'v' }, 'L', '$', { desc = 'Jump to end of the line' })
...
vim.api.nvim_create_autocmd('ModeChanged', {
  ...
  group = vim.api.nvim_create_augroup('kickstart-stop-snippet', { clear = true }),
  callback = function()
    if
